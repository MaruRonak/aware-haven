...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Cyber Raksha — Awareness · Prevention · Reporting" },
      { property: "og:description", content: "SOS, AI scam detection, awareness quizzes and live location for women, children and seniors." },
